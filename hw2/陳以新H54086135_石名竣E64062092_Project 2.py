# sort by exeMax from little to large: 7 tasks; response 1356.79; util 0.8816
    ...
    for i in range(time):
        ...
        for j in range(len(selected)): # job release and put into readyQueue
            ...
            and len(onlineJob[selected[j].getInfo("id")]) > 0: # job release
                ...
                print(int(systemTime), "\tTask{:4}   release,  execution time =".format(selected[j].getInfo("id")), et,"exeMax = ",selected[j].getInfo("exeMax"),  sep = "  ")
